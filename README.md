...
<u>Disclaimer sur l’utilisation de l’IA :</u>
...
<u>3.2 L’authentification et la gestion des utilisateurs :</u>
...
<u>3.3 Gestion des scores et du jeu :</u>

- Enregistrement de la configuration du profil.
- Affichage des scores.

<u>3.4 Choix des jeux :</u>
...
<u>4.1 HTML (index essentiellement):</u>
...
```<div class="rotate-message">``` Pour m'éviter trop de contraintes responsives avec ma mise en page, j'ai bloqué l'option portrait en Smartphone.
...
Sans être graphiste, j'ai remanié les images pour les mettre au même format (.png) et ainsi me faciliter dans le code.
...
Pensez à compléter le code des "select" du profil.
